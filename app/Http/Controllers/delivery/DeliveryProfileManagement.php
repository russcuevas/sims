...
class DeliveryProfileManagement extends Controller
{
    public function DeliveryProfileManagementPage()
    {
        ...
        return view('delivery.edit_profile', compact('role', 'user', 'lowFinishedProducts'));
    }

    public function DeliveryUpdateProfile(Request $request)
    {
        $user = Auth::guard('employees')->user();
