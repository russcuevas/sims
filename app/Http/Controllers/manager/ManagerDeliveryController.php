...
{
    public function ManagerDeliveryPage(Request $request)
    {
        ...
        return view('manager.delivery_management', compact(
            'role',
            'user',
            'lowFinishedProducts',
            'products',
    ...
    public function ManagerDeliverySubmitBatch(Request $request)
    {
        if (!Auth::guard('employees')->check() || Auth::guard('employees')->user()->position_id != 2) {
            return redirect()->route('login.page')->with('error', 'You must be logged in as an manager to access the dashboard.');
        }
        ...
        return redirect()->route('manager.delivery.management.page')->with('success', 'Batch products added successfully!');
    }



    public function ManagerDeliveryAddStore(Request $request)
    {
        $request->validate([
        ...
        return redirect()->route('manager.delivery.management.page')->with('success', 'Store added successfully!');
    }

    public function ManagerAddCar(Request $request)
    {
        $request->validate([
        ...
        return redirect()->route('manager.delivery.management.page')->with('success', 'Car added successfully!');
    }

    public function ManagerDeliveryRemoveProduct($id)
    {
        $product = BatchFetchFinishProducts::find($id);

        if ($product) {
            $product->delete();
            return redirect()->route('manager.delivery.management.page')->with('success', 'Product removed successfully!');
        } else {
            return redirect()->route('manager.delivery.management.page')->with('error', 'Product not found.');
        }
    }

    public function ManagerDeliveryAdd(Request $request)
    {
        ...
        return redirect()->route('manager.delivery.management.page')
            ->with('success', 'Delivery added successfully!');
    }

    public function ManagerViewDeliveryOrder($transact_id)
    {
        if (!Auth::guard('employees')->check() || Auth::guard('employees')->user()->position_id != 2) {
            return redirect()->route('login.page')->with('error', 'You must be logged in as an manager to access the dashboard.');
        }
    ...
    public function ManagerArchiveDeliveryOrder($transact_id)
    {
        if (!Auth::guard('employees')->check() || Auth::guard('employees')->user()->position_id != 2) {
            return redirect()->route('login.page')->with('error', 'You must be logged in as an manager to access the dashboard.');
        }
