...
class ManagerDeliveryStatusController extends Controller
{
    public function ManagerDeliveryStatusPage(Request $request)
    {
        ...
        return view('manager.delivery_status', compact('role', 'user', 'lowFinishedProducts', 'deliveryOrders', 'employees'));
    }
}
