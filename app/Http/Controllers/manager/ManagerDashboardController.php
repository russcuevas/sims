...
{
    public function ManagerDashboardPage()
    {
    ...
    public function ManagerGetMonthlySales(Request $request)
    {
    ...
    public function ManagerGetAvailableProductsByType(Request $request)
    {
