...
class ManagerPendingDeliveryController extends Controller
{
    public function ManagerPendingDeliveryPage(Request $request)
    {
        ...
        return view('manager.pending_delivery', compact(
            'role',
            'user',
            'lowFinishedProducts',
            'deliveryOrders',
    ...
    public function ManagerMarkStatusDelivery(Request $request, $transact_id)
    {
        $request->validate([
