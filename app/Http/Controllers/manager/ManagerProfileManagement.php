...
class ManagerProfileManagement extends Controller
{
    public function ManagerProfileManagementPage()
    {
        ...
        return view('manager.edit_profile', compact('role', 'user', 'lowFinishedProducts'));
    }
