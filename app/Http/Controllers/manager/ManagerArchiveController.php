...
class ManagerArchiveController extends Controller
{
    public function ManagerArchivePage()
    {
        ...
        return view('manager.archive', compact('role', 'user', 'lowFinishedProducts', 'archivedEmployees'));
    }

    public function ManagerRestoreEmployee($id)
    {
        if (!Auth::guard('employees')->check() || Auth::guard('employees')->user()->position_id != 2) {
            return redirect()->route('login.page')->with('error', 'You must be logged in as an manager to access the dashboard.');
        }
    ...
    public function ManagerArchiveStocksPage()
    {
        if (!Auth::guard('employees')->check() || Auth::guard('employees')->user()->position_id != 2) {
            return redirect()->route('login.page')->with('error', 'You must be logged in as an manager to access the dashboard.');
        }
        ...
        return view('manager.archive_stocks', compact('role', 'user', 'lowFinishedProducts', 'archivedStocks'));
    }

    public function ManagerRestoreStocks($id)
    {
    ...
    public function ManagerArchiveStockInPage()
    {
        if (!Auth::guard('employees')->check() || Auth::guard('employees')->user()->position_id != 2) {
            return redirect()->route('login.page')->with('error', 'You must be logged in as an manager to access the dashboard.');
        }
        ...
        return view('manager.archive_stock_in', compact('role', 'user', 'lowFinishedProducts', 'historyGroups'));
    }

    public function ManagerRestoreStockIn($transact_id)
    {
    ...
    public function ManagerArchiveProcessPage()
    {
        if (!Auth::guard('employees')->check() || Auth::guard('employees')->user()->position_id != 2) {
            return redirect()->route('login.page')->with('error', 'You must be logged in as an manager to access the dashboard.');
        }
        ...
        return view('manager.archive_process', compact(
            'role',
            'user',
            'lowFinishedProducts',
            'archivedHistory'
    ...
    public function ManagerRestoreProcess($transact_id)
    {
    ...
    public function ManagerArchiveDeliveryPage()
    {
        if (!Auth::guard('employees')->check() || Auth::guard('employees')->user()->position_id != 2) {
            return redirect()->route('login.page')->with('error', 'You must be logged in as an manager to access the dashboard.');
        }
        ...
        return view('manager.archive_delivery', compact(
            'role',
            'user',
            'lowFinishedProducts',
            'deliveryOrders'
    ...
    public function ManagerRestoreDelivery($transact_id)
    {
    ...
    public function ManagerArchiveSalesPage()
    {
        if (!Auth::guard('employees')->check() || Auth::guard('employees')->user()->position_id != 2) {
            return redirect()->route('login.page')->with('error', 'You must be logged in as an manager to access the dashboard.');
        }
        ...
        return view('manager.archive_sales', compact(
            'role',
            'user',
            'lowFinishedProducts',
            'transactions',
    ...
    public function ManagerRestoreSales($id)
    {
