...
{
    public function ManagerProcessManagementPage(Request $request)
    {
        ...
        return view('manager.process_management', compact(
            'products',
            'batchProducts',
            'role',
            'user',
    ...
    public function ManagerRemoveBatchRawProduct($id)
    {
    ...
    public function ManagerAddBatchFetchRawProducts(Request $request)
    {
        $request->validate([
    ...
    public function ManagerAddBatchFinishProduct(Request $request)
    {
        if (!Auth::guard('employees')->check() || Auth::guard('employees')->user()->position_id != 2) {
            return redirect()->route('login.page')->with('error', 'You must be logged in as an manager.');
        }
    ...
    public function ManagerFinishProductSubmit(Request $request)
    {
        if (!Auth::guard('employees')->check() || Auth::guard('employees')->user()->position_id != 2) {
            return redirect()->route('login.page')->with('error', 'You must be logged in as an manager.');
        }
        ...
        return redirect()->route('manager.process.management.page')->with('success', 'Finished products submitted successfully');
    }


    public function ManagerRemoveFinishProduct($id)
    {
    ...
    public function ManagerArchiveHistoryFinishProduct(Request $request, $transactId)
    {
