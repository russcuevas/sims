...
{
    public function SupervisorDashboardPage()
    {
    ...
    public function SupervisorGetMonthlySales(Request $request)
    {
    ...
    public function SupervisorGetAvailableProductsByType(Request $request)
    {
