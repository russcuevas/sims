...
class SupervisorViewAvailableCarsController extends Controller
{
    public function SupervisorViewAvailableCarsPage(Request $request)
    {
        ...
        return view('supervisor.view_available_cars', compact('cars', 'lowFinishedProducts'));
    }
}
