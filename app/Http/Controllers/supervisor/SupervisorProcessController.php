...
{
    public function SupervisorProcessManagementPage(Request $request)
    {
        ...
        return view('supervisor.process_management', compact(
            'products',
            'batchProducts',
            'role',
            'user',
    ...
    public function SupervisorRemoveBatchRawProduct($id)
    {
    ...
    public function SupervisorAddBatchFetchRawProducts(Request $request)
    {
        $request->validate([
...
// Validate inputs
    ...
    public function SupervisorAddBatchFinishProduct(Request $request)
    {
        if (!Auth::guard('employees')->check() || Auth::guard('employees')->user()->position_id != 4) {
            return redirect()->route('login.page')->with('error', 'You must be logged in as an supervisor.');
        }
    ...
    public function SupervisorFinishProductSubmit(Request $request)
    {
        if (!Auth::guard('employees')->check() || Auth::guard('employees')->user()->position_id != 4) {
            return redirect()->route('login.page')->with('error', 'You must be logged in as an supervisor.');
        }
        ...
        return redirect()->route('supervisor.process.management.page')->with('success', 'Finished products submitted successfully');
    }


    public function SupervisorRemoveFinishProduct($id)
    {
    ...
    public function SupervisorArchiveHistoryFinishProduct(Request $request, $transactId)
    {
