...
class SupervisorPendingDeliveryController extends Controller
{
    public function SupervisorPendingDeliveryPage(Request $request)
    {
        ...
        return view('supervisor.pending_delivery', compact(
            'role',
            'user',
            'lowFinishedProducts',
            'deliveryOrders',
    ...
    public function SupervisorMarkStatusDelivery(Request $request, $transact_id)
    {
        $request->validate([
