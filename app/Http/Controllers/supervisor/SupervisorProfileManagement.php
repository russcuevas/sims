...
class SupervisorProfileManagement extends Controller
{
    public function SupervisorProfileManagementPage()
    {
        ...
        return view('supervisor.edit_profile', compact('role', 'user', 'lowFinishedProducts'));
    }

    public function SupervisorUpdateProfile(Request $request)
    {
        $user = Auth::guard('employees')->user();
