...
class SupervisorDeliveryStatusController extends Controller
{
    public function SupervisorDeliveryStatusPage(Request $request)
    {
        ...
        return view('supervisor.delivery_status', compact('role', 'user', 'lowFinishedProducts', 'deliveryOrders', 'employees'));
    }
}
