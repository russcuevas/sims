...
class SupervisorReturnItemController extends Controller
{
    public function SupervisorReturnItemPage(Request $request)
    {
        ...
        return view('supervisor.return_item', compact(
            'role',
            'user',
            'allEmployees',
            'products',
    ...
    public function SupervisorBatchReturnProductSubmit(Request $request)
    {
        $request->validate([
    ...
    public function SupervisorAddReturnItem(Request $request)
    {
        $request->validate([
        ...
        return redirect()->route('supervisor.return.item.page')->with('success', 'Return item submitted successfully.');
    }

    public function SupervisorDeleteBatchReturnProduct($id)
    {
