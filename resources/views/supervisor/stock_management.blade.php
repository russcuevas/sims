                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex gap-2">
                                                            ...
                                                            @forelse($purchaseOrders as $order)
                                                                <tr>
                                                                    <td style="color: black">
                                                                        <a target="_blank" href="{{ route('supervisor.view.po', $order->po_number) }}" class="btn btn-primary">
                                                                            View
                                                                        </a>
                                                                    </td>
                                    ...
                                    <a href="{{ route('supervisor.purchase.order.page') }}" target="_blank" class="btn btn-primary position-relative">
                                        View P.O
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <div class="d-flex flex-wrap justify-content-center gap-2 mb-3">
                                        <form method="GET" action="{{ route('supervisor.stock.management.page') }}" class="d-flex gap-2 align-items-center mb-3">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="filterDropdown">
                                                    <li><a class="dropdown-item" href="{{ route('supervisor.stock.management.page', request()->except('category')) }}">All</a></li>
                                                    @foreach($categories as $category)
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('supervisor.stock.management.page', array_merge(request()->except('category'), ['category' => $category])) }}">
                                                                {{ ucfirst($category) }}
                                                            </a>
                                                        </li>
                                                    @endforeach
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="sortDropdown">
                                                    ...
                                                    @foreach($sortOptions as $key => $label)
                                                        @foreach($directions as $dirKey => $dirLabel)
                                                            <li>
                                                                <a class="dropdown-item" href="{{ route('supervisor.stock.management.page', array_merge(request()->except(['sort_by', 'sort_dir']), ['sort_by' => $key, 'sort_dir' => $dirKey])) }}">
                                                                    {{ $label }} - {{ $dirLabel }}
                                                                </a>
                                                            </li>
                                                        @endforeach
                                            ...
                                            @forelse ($productDetails as $product)
                                                <tr>
                                                    ...
                                                    {{-- <td>
                                                        ...
                                                        <form action="{{ route('supervisor.stock.archive.product', ['id' => $product->id]) }}" method="POST" style="display: inline;">
                                                            @csrf
                                                ...
                                                <div class="modal fade" id="updateProductModal{{ $product->id }}" tabindex="-1" role="dialog" aria-labelledby="modalLabel{{ $product->id }}" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <form action="{{ route('supervisor.stock.update.product', ['id' => $product->id]) }}" method="POST">
                                                            @csrf
                                                            <div class="modal-content">
                                                                <div class="modal-header">
