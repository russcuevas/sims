                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="container my-4">
                                    <form action="{{ route('supervisor.batch.add.raw.products') }}" method="POST">
                                        @csrf
                                                    ...
                                                    @forelse($batchProducts as $product)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="{{ route('supervisor.batch.raw.product.remove', $product->id) }}" 
                                ...
                                <div class="table-responsive">
                                    <form action="{{ route('supervisor.finish.product.submit') }}" method="POST">
                                        @csrf
                                                ...
                                                @forelse($finishProducts as $product)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            href="{{ route('supervisor.batch.finish.product.remove', ['id' => $product->id]) }}"
                                ...
                                <div class="d-flex flex-wrap justify-content-center gap-2 mb-3">
                                    <form method="GET" action="{{ route('supervisor.process.management.page') }}" class="d-flex flex-wrap justify-content-center gap-2 mb-3" id="filterSortForm">
                                        ...
                                        <tbody>
                                            @forelse ($historyRecords as $transactId => $records)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="{{ route('supervisor.archive.history.finish.product', ['transactId' => $transactId]) }}" method="POST" onsubmit="return confirm('Are you sure you want to archive this?')">
                                                            @csrf
    ...
    $(document).on('click', '.finish-product-btn', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{ route('supervisor.batch.finish.product') }}",
                    type: 'POST',
                    data: {
                        _token: "{{ csrf_token() }}",
