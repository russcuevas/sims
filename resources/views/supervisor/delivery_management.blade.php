            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a style="color: #D96F32;" href="{{ route('supervisor.dashboard.page')}}">Dashboard</a></li>
                            ...
                            <div class="container my-4">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    <div class="col-auto px-1">
                                        <a href="{{ route('supervisor.delivery.management.page') }}" class="btn btn-primary" id="status_preparing">Preparing</a>
                                    </div>
                                    <div class="col-auto px-1">
                                        <a href="{{ route('supervisor.return.item.page') }}" class="btn btn-outline-primary" id="status_to_ship">Return item</a>
                                    </div>
                                    <div class="col-auto px-1">
                                        <a href="{{ route('supervisor.pending.management.page') }}" class="btn btn-outline-primary" id="status_delivered">Pending delivery</a>
                                    </div>
                                    <div class="col-auto px-1">
                            ...
                            <div class="card-body">
                                <div class="container my-4">
                                    ...
                                    <div class="row mb-3 justify-content-end">
                                        ...
                                        <a href="{{ route('supervisor.view.available.cars') }}" class="btn btn-outline-primary w-100">
                                            View available cars
                                        </a>
                                        </div>
                                        <div class="col-md-2 text-end">
                                    ...
                                    <div class="modal fade" id="add_car">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('supervisor.delivery.add.car') }}" method="POST">
                                                    @csrf
                                    ...
                                    <div class="modal fade" id="add_store_modal">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('supervisor.delivery.add.store') }}" method="POST">
                                                        @csrf
                                                    <div class="modal-body">
                                ...
                                <form action="{{ route('supervisor.delivery.submit.batch') }}" method="POST">
                                        @csrf
                                ...
                                <form action="{{ route('supervisor.delivery.add') }}" method="POST">
                                    @csrf                                    
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($fetch_finished_products as $batch)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('supervisor.delivery.remove.product', $batch->id) }}" 
