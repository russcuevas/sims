                        ...
                        <div class="card">
                            ...
                            <div class="container my-4">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-auto px-1">
                                        <a href="{{ route('supervisor.archive.stock.in.page') }}" class="btn btn-primary">Stock In History</a>
                                    </div>
                                    <div class="col-auto px-1">
                                        ...
                                        <tbody>
                                            @forelse ($historyGroups as $transactId => $group)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="{{ route('supervisor.stockin.restore', ['transact_id' => $transactId]) }}" method="POST" style="display:inline;">
                                                            @csrf
