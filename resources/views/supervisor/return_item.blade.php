                        ...
                        <div class="card">
                            ...
                            <div class="container my-4">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    ...
                                    <div class="col-auto px-1">
                                        <a href="{{ route('supervisor.return.item.page') }}" class="btn btn-primary" id="status_to_ship">Return item</a>
                                    </div>
                                    <div class="col-auto px-1">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('supervisor.return.submit.item') }}" method="POST">
                                        @csrf
                                ...
                                <form action="{{ route('supervisor.return.submit') }}" method="POST">
                                    @csrf                                    
                                ...
                                <div class="table-responsive">
                                        ...
                                        @forelse ($batchProducts as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('supervisor.batch-return-item.delete', $item->id) }}" class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure you want to remove this item?');">
