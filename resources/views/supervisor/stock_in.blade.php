                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="container my-4">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="modal-body">
                                                            <form class="add_product_validation" action="{{ route('supervisor.stock.in.add.product') }}" method="POST">
                                                                @csrf
                                        ...
                                        <div class="modal fade" id="add_supplier_modal">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="modal-body">
                                                            <form class="add_suppliers_validation" action="{{ route('supervisor.stock.in.add.supplier') }}" method="POST">
                                                                @csrf
                                                                <div class="form-group row mb-3">
                                    ...
                                    {{-- CHANGES REVISIONS --}}
                                    <form action="{{ route('supervisor.stock.in.add.batch.product.details') }}" method="POST">
                                        @csrf
                                ...
                                <form action="{{ route('supervisor.raw.stocks.request') }}" method="POST">
                                    @csrf
                                    <div class="row mb-3">
                                        {{-- CHANGES REVISIONS --}}
                                            ...
                                            <tbody>
                                                @forelse($batchProductDetails as $detail)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('supervisor.batch.product.remove', $detail->id) }}"
                            ...
                            <div class="d-flex flex-wrap justify-content-center gap-2 mb-3">
                                <form method="GET" action="{{ route('supervisor.stock.in.page') }}" class="d-flex flex-wrap justify-content-center gap-2 mb-3" id="filterSortForm">
    ...
    <script>
        ...
        document.querySelectorAll('.update-quantity').forEach(input => {
            input.addEventListener('change', function () {
                ...
                fetch(`/supervisor/batch-product-details/${batchDetailId}/quantity`, {
                    method: 'POST',
                    headers: {
        ...
        document.querySelectorAll('.update-price').forEach(input => {
            input.addEventListener('change', function () {
                ...
                fetch(`/supervisor/products/${productId}/update-price`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
