            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a style="color: #A16D28;" href="{{ route('supervisor.delivery.management.page') }}">Delivery Management</a></li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <div class="d-flex flex-wrap justify-content-center gap-2 mb-3">
                                        <form method="GET" action="{{ route('supervisor.view.available.cars') }}" class="d-flex gap-2 align-items-center mb-3">
                                            ...
                                            <div class="dropdown me-2">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="filterDropdown">
                                                    <li><a class="dropdown-item" href="{{ route('supervisor.view.available.cars', ['filter' => 'Available']) }}">Available</a></li>
                                                    <li><a class="dropdown-item" href="{{ route('supervisor.view.available.cars', ['filter' => 'Not Available']) }}">Not Available</a></li>
                                                    <li><a class="dropdown-item" href="{{ route('supervisor.view.available.cars') }}">Clear Filter</a></li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="sortDropdown">
                                                    <li><a class="dropdown-item" href="{{ route('supervisor.view.available.cars', ['sort' => 'asc']) }}">Availability Ascending</a></li>
                                                    <li><a class="dropdown-item" href="{{ route('supervisor.view.available.cars', ['sort' => 'desc']) }}">Availability Descending</a></li>
                                                    <li><a class="dropdown-item" href="{{ route('supervisor.view.available.cars') }}">Clear Sort</a></li>
                                                </ul>
                                            </div>
                                    ...
                                    <a href="{{ route('supervisor.delivery.management.page') }}" style="color: white; cursor: pointer;" class="btn btn-primary float-right">Go back</a>
                                </div>
                            </div>
                        </div>
                    </div>
