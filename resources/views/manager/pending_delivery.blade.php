                            ...
                            <div class="container my-4">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    <div class="col-auto px-1">
                                        <a href="{{ route('manager.pending.management.page') }}" class="btn btn-primary" id="status_delivered">Pending delivery</a>
                                    </div>
                                    <div class="col-auto px-1">
                                        ...
                                        <thead class="table-light fw-bold">
                                            ...
                                            <tbody>
                                                @forelse($deliveryOrders as $transactId => $orders)
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a target="_blank" href="{{ route('manager.delivery.view', $transactId) }}" class="btn btn-outline-primary btn-sm">View</a>
                                                        </td>
                                                        ...
                                                        {{-- <form id="form-{{ $transactId }}" method="POST" action="{{ route('manager.delivery.mark.status', $transactId) }}" enctype="multipart/form-data">
                                                            @csrf
                                                        <td>
