                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <a href="{{ route('manager.sales.report.print') }}" 
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="modal-body">
                                                            <form class="add_transaction_validation" action="{{ route('manager.sales.request.transaction') }}" method="POST">
                                                                @csrf
                                        ...
                                        <tbody>
                                            @forelse($transactions as $transaction)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="{{ route('manager.transaction.archive', $transaction->id) }}" method="POST" style="display:inline;">
                                                            @csrf
