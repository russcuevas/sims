                    ...
                    <div class="col-12">
                        <div class="card">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="modal-body">
                                                            <form class="add_product_validation" action="{{ route('manager.stock.in.add.product') }}" method="POST">
                                                                @csrf
                                        ...
                                        <div class="modal fade" id="add_supplier_modal">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="modal-body">
                                                            <form class="add_suppliers_validation" action="{{ route('manager.stock.in.add.supplier') }}" method="POST">
                                                                @csrf
                                                                <div class="form-group row mb-3">
                                            ...
                                            <tbody>
                                                @forelse($batchProductDetails as $detail)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('manager.batch.product.remove', $detail->id) }}"
                            ...
                            <div class="d-flex flex-wrap justify-content-center gap-2 mb-3">
                                <form method="GET" action="{{ route('manager.stock.in.page') }}" class="d-flex flex-wrap justify-content-center gap-2 mb-3" id="filterSortForm">
    ...
    <script>
        ...
        document.querySelectorAll('.update-quantity').forEach(input => {
            input.addEventListener('change', function () {
                ...
                fetch(`/manager/batch-product-details/${batchDetailId}/quantity`, {
                    method: 'POST',
                    headers: {
        ...
        document.querySelectorAll('.update-price').forEach(input => {
            input.addEventListener('change', function () {
                ...
                fetch(`/manager/products/${productId}/update-price`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
