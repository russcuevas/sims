...
<style>
    ...
    @media print {
        ...
        <div style="text-align: right; margin:20px;">
            <button id="backButton" onclick="window.location.href='/manager/return_item'" style="padding: 8px 20px; font-size: 14px;">Back</button>
        </div>
        ...
        <div class="info-section">
            <div class="info-row">
                <div class="info-item"><strong>Supplier Name:</strong> {{ $first->process_by ?? '(manager)' }}</div>
    ...
    <table class="product-table">
        ...
        <tbody>
<form method="POST" action="{{ route('manager.return.update', ['transact_id' => $first->transact_id]) }}">
            @csrf
