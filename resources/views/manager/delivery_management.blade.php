            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a style="color: #D96F32;" href="{{ route('manager.dashboard.page')}}">Dashboard</a></li>
                            ...
                            <div class="container my-4">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    <div class="col-auto px-1">
                                        <a href="{{ route('manager.delivery.management.page') }}" class="btn btn-primary" id="status_preparing">Preparing</a>
                                    </div>
                                    <div class="col-auto px-1">
                                        <a href="" class="btn btn-outline-primary" id="status_payment">Payment</a>
                                    </div>
                                    <div class="col-auto px-1">
                                        <a href="{{ route('manager.return.item.page') }}" class="btn btn-outline-primary" id="status_to_ship">Return item</a>
                                    </div>
                                    <div class="col-auto px-1">
                            ...
                            <div class="card-body">
                                <div class="container my-4">
                                    ...
                                    <div class="row mb-3 justify-content-end">
                                        ...
                                        <a href="{{ route('manager.view.available.cars') }}" class="btn btn-outline-primary w-100">
                                            View available cars
                                        </a>
                                        </div>
                                        <div class="col-md-2 text-end">
                                    ...
                                    <div class="modal fade" id="add_car">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('manager.delivery.add.car') }}" method="POST">
                                                    @csrf
                                    ...
                                    <div class="modal fade" id="add_store_modal">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('manager.delivery.add.store') }}" method="POST">
                                                        @csrf
                                                    <div class="modal-body">
                                ...
                                <form action="{{ route('manager.delivery.submit.batch') }}" method="POST">
                                        @csrf
                                ...
                                <form action="{{ route('manager.delivery.add') }}" method="POST">
                                    @csrf                                    
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($fetch_finished_products as $batch)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('manager.delivery.remove.product', $batch->id) }}" 
                                ...
                                <table id="delivery-table" class="table table-bordered text-center align-middle">
                                        ...
                                        <tbody>
                                            @forelse($deliveryOrders as $transactId => $orders)
                                                ...
                                                <tr>
                                                    <td>
                                                        <a  href="{{ route('manager.delivery.view', $transactId) }}" class="btn btn-outline-primary btn-sm">View</a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <form method="POST" action="{{ route('manager.delivery.archive', $transactId) }}">
                                                            @csrf
