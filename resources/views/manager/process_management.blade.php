                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="container my-4">
                                    <form action="{{ route('manager.batch.add.raw.products') }}" method="POST">
                                        @csrf
                                                    ...
                                                    @forelse($batchProducts as $product)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="{{ route('manager.batch.raw.product.remove', $product->id) }}" 
                                ...
                                <div class="modal fade" id="add_product_modal">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form class="add_product_validation" action="{{ route('manager.add.batch.multiple.product') }}" method="POST">
                                                @csrf
                                                <div class="modal-body">
                                ...
                                <div class="table-responsive">
                                    <form action="{{ route('manager.finish.product.submit') }}" method="POST">
                                        @csrf
                                                ...
                                                @forelse($finishProducts as $product)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            href="{{ route('manager.batch.finish.product.remove', ['id' => $product->id]) }}"
                                ...
                                <div class="d-flex flex-wrap justify-content-center gap-2 mb-3">
                                    <form method="GET" action="{{ route('manager.process.management.page') }}" class="d-flex flex-wrap justify-content-center gap-2 mb-3" id="filterSortForm">
                                        ...
                                        <tbody>
                                            @forelse ($historyRecords as $transactId => $records)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="{{ route('manager.archive.history.finish.product', ['transactId' => $transactId]) }}" method="POST" onsubmit="return confirm('Are you sure you want to archive this?')">
                                                            @csrf
    ...
    $(document).on('click', '.finish-product-btn', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{ route('manager.batch.finish.product') }}",
                    type: 'POST',
                    data: {
                        _token: "{{ csrf_token() }}",
