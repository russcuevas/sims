...
<body>
  <div class="d-flex">
    <!-- Sidebar -->
    <div class="sidebar">
      <a href="{{ route('admin.email.management.page') }}">Sent</a>
      <a href="{{ route('admin.email.trash') }}" class="active">Trash</a>
    </div>

    <!-- Archived Emails List -->
    <div class="flex-grow-1 p-4">
      <div class="d-flex justify-content-between align-items-center mb-3">
  <a href="/admin/dashboard" style="text-decoration: none">Back to dashboard</a>

  <div class="d-flex gap-2">
    <form id="restoreEmailsForm" action="{{ route('admin.email.bulkRestore') }}" method="POST">
      @csrf
    ...
    <form id="deleteEmailsForm" action="{{ route('admin.email.bulkDeletePermanent') }}" method="POST">
      @csrf
