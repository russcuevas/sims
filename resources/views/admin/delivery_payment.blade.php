                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a style="color: #A16D28;"
                                    href="{{ route('admin.dashboard.page')}}">Dashboard</a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="container my-4">
                                ...
                                <div class="row mb-3 justify-content-center">
                                    <div class="col-auto px-1">
                                        <a href="{{ route('admin.delivery.management.page') }}"
                                            class="btn btn-outline-primary" id="status_preparing">Preparing</a>
                                    </div>
                                    <div class="col-auto px-1">
                                        <a href="{{ route('admin.payment.item.page') }}" class="btn btn-primary" id="status_payment">Payment</a>
                                    </div>
                                    <div class="col-auto px-1">
                                    ...
                                    <div class="col-auto px-1">
                                        <a href="{{ route('admin.delivery.status.page') }}"
                            ...
                            <div class="card-body">
                                <div class="container my-4">
                                    <form action="{{ route('admin.payment.fetch') }}" method="GET">
                                            ...
                                            @if ($transactId)
                                                <tr>
                                                    <td colspan="7" class="text-center">
                                                        <form method="POST" action="{{ route('admin.payment.updateTransact') }}" class="d-flex justify-content-center gap-2">
                                                            @csrf
                                                            @method('PUT')
