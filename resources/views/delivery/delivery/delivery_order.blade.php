...
<body>
    ...
    <div style="text-align: right; margin:20px;">
        <button id="backButton" onclick="window.location.href='/delivery/dashboard'" style="padding: 8px 20px; font-size: 14px;">Back</button>
    ...
    <div class="info-section">
        <div class="info-row">
            <div class="info-item"><strong>Supplier Name:</strong> {{ $first->process_by ?? '(delivery)' }}</div>
...
<script>
    document.getElementById('btn-validate-pin').addEventListener('click', async function () {
        ...
        Swal.fire({
            ...
            preConfirm: (pin) => {
                return fetch('/delivery/validate-pin-delivery', {
                    method: 'POST',
                    headers: {
